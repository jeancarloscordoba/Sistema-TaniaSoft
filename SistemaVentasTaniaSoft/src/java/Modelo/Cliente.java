...
@Entity
@Table(name="cliente")
public class Cliente implements Serializable{//Esta clase Cliente se utiliza para crear las variables y las acciones del sistema (en la parte de Cliente) que la base de datos almacenara. (Atributos y metodos)
